...
class MetaProcess():
    ...
    def update_meta_file(extract_date_list: list, meta_key: str, bucket_meta: S3BucketConnector):
        """
        ...
        :param: bucket_meta -> S3BucketConnector for the bucket with the meta file
        """
        ...
        except bucket_meta.session.client('s3').exceptions.NoSuchKey:
            df_all=df_new
        # Writing to S3
